...
<section class="w-100 h-100 ">
    <div class="otpverify">
        ...
        <div class="otpContent">
            ...
            <form  action = "{{route('otp.verify')}}" id="otp_verify_form"  method="POST">
                @csrf
            <div class="inputfield">
                ...
                <div class="text-center">
                    <a href="{{route('resend.otp',['username' => $tempuser->email,'type' => 'email','user_type'=>'temp_user','user_id' => $tempuser->id])}}" class="text-primary text-center">Resend OTP</a>
                </div>
